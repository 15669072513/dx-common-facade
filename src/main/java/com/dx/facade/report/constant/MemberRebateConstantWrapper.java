 ...
 * 代理反点相关枚举
 */
public class MemberRebateConstantWrapper {
    ...
    public  enum PayoutStatusEnum {
        ...
        public static MemberRebateConstantWrapper.PayoutStatusEnum getType(Integer code) {
            MemberRebateConstantWrapper.PayoutStatusEnum[] var1 = values();
            int var2 = var1.length;
            for(int var3 = 0; var3 < var2; ++var3) {
                MemberRebateConstantWrapper.PayoutStatusEnum type = var1[var3];
                if (type.code.equals(code)) {
                    return type;
                }
            }

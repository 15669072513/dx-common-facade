...
import com.dx.facade.report.resp.report.PlayerDayReportDetailInfoDTO;
...
public interface PlayerDayReportRPCService {
     ...
     * @throws BizException
     */
    CommonResp<PlayerDayReportDetailInfoDTO> detailListPage(PlayerDayReportDetailReqDTO requestDto) throws BizException;
}

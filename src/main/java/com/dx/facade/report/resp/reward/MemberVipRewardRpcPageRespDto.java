 ...
 * @date 2021/6/14
 */
@ApiModel(value = "com-ob-vip-resp-MemberVipRewardRpcPageRespDto", description = "会员vip奖励发放记录 返回参数")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class MemberVipRewardRpcPageRespDto implements Serializable {

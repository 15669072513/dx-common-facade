...
public interface ExcelHeadI18nKey {
    ...
    String REPORT_注单子类 = "EXCEL_HEAD_I18N_KEY.REPORT_注单子类";
    ...
    String  FUNDS_服务费贡献 = "EXCEL_HEAD_I18N_KEY.FUNDS_服务费贡献";
    ...
    String	FUNDS_总取款金额 = "EXCEL_HEAD_I18N_KEY.FUNDS_总取款金额";
    String	FUNDS_总取款次数 = "EXCEL_HEAD_I18N_KEY.FUNDS_总取款次数";
    ...
    String	FUNDS_应还借款 = "EXCEL_HEAD_I18N_KEY.FUNDS_应还借款";
    String	FUNDS_外放额度 = "EXCEL_HEAD_I18N_KEY.FUNDS_外放额度";
    String	FUNDS_授信总额 = "EXCEL_HEAD_I18N_KEY.FUNDS_授信总额";
    ...
    String FUNDS_会员流水纠正 = "EXCEL_HEAD_I18N_KEY.FUNDS_会员流水纠正";
    String FUNDS_代理总返点 = "EXCEL_HEAD_I18N_KEY.FUNDS_代理总返点";

    String FUNDS_日志ID = "EXCEL_HEAD_I18N_KEY.FUNDS_日志ID";
    String FUNDS_用户账号 = "EXCEL_HEAD_I18N_KEY.FUNDS_用户账号";
    String FUNDS_登录时间 = "EXCEL_HEAD_I18N_KEY.FUNDS_登录时间";
    String FUNDS_登出时间 = "EXCEL_HEAD_I18N_KEY.FUNDS_登出时间";
    String FUNDS_登录IP = "EXCEL_HEAD_I18N_KEY.FUNDS_登录IP";
    String FUNDS_IP地址 = "EXCEL_HEAD_I18N_KEY.FUNDS_IP地址";
    ...
    String PERSON_TEXAS_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_德州俱乐部个人返水";
    String PERSON_TEXAS_INSURANCE_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_德州保险个人返水";
    String PERSON_ACTUAL_PERSON_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_真人个人返水";
    String PERSON_SPORTS_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_体育个人返水";
    String PERSON_LOTTERY_TICKET_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_彩票个人返水";
    String PERSON_CHESS_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_棋牌个人返水";
    String PERSON_ESPORTS_REBATE = "EXCEL_HEAD_I18N_KEY.PERSON_电竞个人返水";
    
    String PERSON_TEXAS_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_德州俱乐部个人返水比例";
    String PERSON_TEXAS_INSURANCE_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_德州保险个人返水比例";
    String PERSON_ACTUAL_PERSON_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_真人个人返水比例";
    String PERSON_SPORTS_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_体育个人返水比例";
    String PERSON_LOTTERY_TICKET_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_彩票个人返水比例";
    String PERSON_CHESS_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_棋牌个人返水比例";
    String PERSON_ESPORTS_REBATE_BATE = "EXCEL_HEAD_I18N_KEY.PERSON_电竞个人返水比例";
    
    String PERSON_TEXAS_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_德州俱乐部个人返点比例";
    String PERSON_TEXAS_INSURANCE_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_德州保险个人返点比例";
    String PERSON_ACTUAL_PERSON_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_真人个人返点比例";
    String PERSON_SPORTS_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_体育个人返点比例";
    String PERSON_LOTTERY_TICKET_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_彩票个人返点比例";
    String PERSON_CHESS_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_棋牌个人返点比例";
    String PERSON_ESPORTS_REBATE_BATE_ = "EXCEL_HEAD_I18N_KEY.PERSON_电竞个人返点比例";

...
@Data
@ApiModel(value = "com-ob-dto-ProxyAssistDownScoreDto", description = "代理下分")
public class ProxyAssistDownScoreDto {
    ...
    @NotNull(message = "下分金额不能为空")
    @ApiModelProperty(value = "下分金额", required = true, example = "10")
    @Min(value = 0, message = "下分金额最小为0")

...
@NoArgsConstructor
@AllArgsConstructor
public class ActivityBonusReleaseEasyExcel {
    ...
    @ExcelProperty(value = "红利金额（元）", index = 1)
    @ColumnWidth(13)
    @ApiModelProperty(value = "红利金额（元）")
    @NotBlank(message = "[红利金额]不能为空")
    @I18nField(headI18nKey = ExcelHeadI18nKey.FUNDS_红利金额)

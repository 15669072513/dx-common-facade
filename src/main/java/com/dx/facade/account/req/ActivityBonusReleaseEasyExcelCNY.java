...
@NoArgsConstructor
@AllArgsConstructor
public class ActivityBonusReleaseEasyExcelCNY {

    @ExcelProperty(value = "会员账号", index = 0,converter = I18nConverter.class)
    @ColumnWidth(15)
    ...
    @ExcelProperty(value = "红利金额", index = 1, converter = I18nConverter.class)
    @ColumnWidth(13)
    @ApiModelProperty(value = "红利金额")
    @NotBlank(message = "[红利金额]不能为空")
    @I18nField(headI18nKey = ExcelHeadI18nKey.FUNDS_红利金额_CNY)

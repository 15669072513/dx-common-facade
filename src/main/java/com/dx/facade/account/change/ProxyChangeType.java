...
public enum ProxyChangeType implements IChangeType {
    ...
    //v2.1新增
    v21_deposit(100, "代理存款", ProxyBizType.v21_deposit.code().toString()),
    v21_withdraw(101, "代理取款", ProxyBizType.v21_withdraw.code().toString()),
    v21_withdraw_frozen(102, "取款冻结", ProxyBizType.v21_withdraw.code().toString()),
    v21_withdraw_fail(103, "取款失败", ProxyBizType.v21_withdraw.code().toString()),

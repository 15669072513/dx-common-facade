...
public enum GlobalConfigEnums {
    ...
    TEXAS_RAISE_POT_PLUS(12, 102, TexasGameTypeEnum.TEXAS.code(), 2, "德州加注加号配置", "德州扑克", "德州加注加号配置"),
    SHORT_DECK_POT_RAISE_PLUS(13, 202, TexasGameTypeEnum.SHORT_CARD.code(), 2, "短牌加注加号配置", "短牌", "短牌加注加号配置"),

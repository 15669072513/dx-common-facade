...
public enum GlobalConfigEnums {
    ...
    TEXAS_RAISE_PLUS(12, 102, TexasGameTypeEnum.TEXAS.code(), 1, "德州加注加号配置", "德州扑克/短牌", "德州加注加号配置"),
    SHORT_DECK_RAISE_PLUS(13, 202, TexasGameTypeEnum.SHORT_CARD.code(), 1, "短牌加注加号配置", "德州扑克/短牌", "短牌加注加号配置"),

...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value = "返点比例试算响应对象", description = "返点比例试算响应对象")
public class RebateRateTryCaclRespDTO implements  Serializable {
    ...
    @ApiModelProperty("德州俱乐部返点比例")
    private BigDecimal texasRebateAfter;
    
    @ApiModelProperty("德州保险返点比例")
    private BigDecimal texasInsuranceRebateAfter;
    
    @ApiModelProperty("真人返点比例")
    private BigDecimal actualPersonRebateAfter;
    
    @ApiModelProperty("体育返点比例")
    private BigDecimal sportsRebateAfter;
    
    @ApiModelProperty("彩票返点比例")
    private BigDecimal lotteryTicketRebateAfter;
    
    private BigDecimal chessRebateAfter;
    
    @ApiModelProperty("电竞返点比例")
    private BigDecimal esportsRebateAfter;
}
